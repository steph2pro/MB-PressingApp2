...
<script type="text/javascript" src="../assets/js/script-retrait.js" defer></script>
...
<div id="elements">
	<table class="table">
			<thead>
				...
				<th>anormalie</th>
				<th>proprietaire</th>
				<th style="background: tomato">retirer??</th>
			</thead>
			<tbody>
				<?php
				...
				<tr class="element">
					...
					<td data-label="retirer??" class="data" style="">
						<?php
						...
						<input type="checkbox" name="retirer" value="oui" id="retirer">
						<b id="retirer">Oui </b>
							<?php
						}
